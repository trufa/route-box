...
var htmlContent = "<div style='width: " + window["finnder_width"] + "; height: 116px;background-color: #EDEDED; padding-top: 20px; padding-left: 20px'>" +
    ...
    "<input style='width: 175px; height:  21px; margin-right: 13px; -webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;' placeholder='Origin Address' id='finnder-addr0' type='text'/>" +
    "<input style='width: 175px; height:  21px; margin-right: 13px; -webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;' placeholder='Destination Address' id='finnder-addr1' type='text'/>" +
